...
@section('title', 'Blog Standard - Antra Architecture & Interior Design')
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header-content">
                    ...
                    <h4 class="sub-title"><a class='home' href='{{ route("home") }}'>Home </a><span class="icon">-</span><a class='inner-page' href='{{ route("blog.standard") }}'> Blog</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
                            ...
                            @forelse($blogs as $blog)
                                <div class="post-card inner-post">
                                    <div class="post-thumb">
                                        ...
                                        @else
                                            <img src="{{ asset('assets/img/blog/post-inner-' . (($loop->index % 3) + 1) . '.png') }}" alt="{{ $blog->title }}">
                                        @endif
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            ...
                            <div class="search-box">
                                <form action="{{ route('blog.standard') }}" method="GET" class="search-form">
                        ...
                        <div class="sidebar-widget">
                            ...
                            <ul class="category-list">
                                @forelse($categories as $cat)
                                    <li>
                                        <a href="{{ route('blog.standard', ['category' => $cat->slug]) }}">
                                            {{ $cat->name }}
