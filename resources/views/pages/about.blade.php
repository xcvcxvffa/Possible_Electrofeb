...
@section('content')
<style>
    /* Custom Mobile Responsiveness for About Page */
    ...
    @media (max-width: 767px) {
        ...
        /* Fix About Section large number */
        ...
        /* Mission & Vision mobile sizing */
        .service-item-2 { padding: 30px 20px !important; border-radius: 16px !important; }
        .service-thumb { height: 200px !important; margin-bottom: 20px !important; }
        .service-item-2 .title { font-size: 22px !important; }
        
        /* Service items (Core Values) */
        .service-item { padding: 30px 20px !important; }
        .service-item .service-top { flex-direction: row !important; align-items: center !important; }
    }
</style>
            ...
            <div class="container container-2">
                ...
                <div class="about-content-9 fade-top">
                    ...
                    <div class="about-desc">
                        <p class="mb-3">POSSIBLE ELECTROFEB 
is dedicated to delivering reliable and efficient electrical panel solutions for industrial, 
commercial, infrastructure and renewable energy applications. We focus on providing high-quality power distribution 
and control systems that ensure safety, performance and long-term operational reliability.</p>
                        <p class="mb-3">With a commitment to innovation and precision engineering, we design and manufacture customized electrical panel 
solutions tailored to diverse project requirements. Our approach emphasizes quality standards, advanced technology 
and dependable service to meet the evolving needs of modern industries.</p>
                        <p class="mb-0">From planning to execution, we strive to build strong partnerships by offering trusted solutions, timely support and 
efficient electrical systems that help power sustainable growth and progress.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container container-2">
                ...
                <div class="row gy-4 pt-4">
                    <div class="col-lg-6 fade-top">
                        <div class="service-item-2 bg-grey p-5 rounded-4 h-100 shadow-sm" style="transition: all 0.4s ease; border-radius: 20px;">
                            <div class="service-thumb mb-4 overflow-hidden" style="height: 260px; border-radius: 16px;">
                                <img src="{{ asset('assets/img/images/Our_Mission.webp') }}" alt="Our Mission" style="height: 100%; width: 100%; object-fit: cover; border-radius: 16px; transition: transform 0.4s ease;">
                            </div>
                    ...
                    <div class="col-lg-6 fade-top">
                        <div class="service-item-2 bg-grey p-5 rounded-4 h-100 shadow-sm" style="transition: all 0.4s ease; border-radius: 20px;">
                            <div class="service-thumb mb-4 overflow-hidden" style="height: 260px; border-radius: 16px;">
                                <img src="{{ asset('assets/img/images/Our_Vision.webp') }}" alt="Our Vision" style="height: 100%; width: 100%; object-fit: cover; border-radius: 16px; transition: transform 0.4s ease;">
                            </div>
                            <div class="service-content">
                    ...
                    <div class="swiper-wrapper antra-swiper-wrapper">
                        <div class="swiper-slide elementor-banner-process-item">
                            <div class="banner-process-caption">
                                ...
                                <h3 class="banner-process-title">Industrial <br> Manufacturing</h3>
                        ...
                        <div class="swiper-slide elementor-banner-process-item">
                            <div class="banner-process-caption">
                                ...
                                <h3 class="banner-process-title">Renewable <br> Energy</h3>
                                <div class="banner-process-content">
                        ...
                        <div class="swiper-slide elementor-banner-process-item">
                            <div class="banner-process-caption">
                                ...
                                <h3 class="banner-process-title">Commercial <br> Buildings</h3>
                                <div class="banner-process-content">
                        ...
                        <div class="swiper-slide elementor-banner-process-item">
                            <div class="banner-process-caption">
                                ...
                                <h3 class="banner-process-title">Wastewater <br> Treatment</h3>
                                <div class="banner-process-content">
                        ...
                        <div class="swiper-slide elementor-banner-process-item">
                            <div class="banner-process-caption">
                                ...
                                <h3 class="banner-process-title">Infrastructure & <br> Utilities</h3>
                                <div class="banner-process-content">
                        ...
                        <div class="swiper-slide elementor-banner-process-item">
                            <div class="banner-process-caption">
                                ...
                                <h3 class="banner-process-title">Data Centers & <br> Facilities</h3>
                                <div class="banner-process-content">
                    ...
                    <div class="banner-process-image-list">
                        <div class="banner-process-img">
                            <div class="process-img">
                                <img src="{{ asset('assets/img/images/Industrial_Manufacturing.webp') }}" alt="Industrial Manufacturing">
                            </div>
                        </div>
                        <div class="banner-process-img">
                            <div class="process-img">
                                <img src="{{ asset('assets/img/images/Renewable_Energy.webp') }}" alt="Renewable Energy">
                            </div>
                        </div>
                        <div class="banner-process-img">
                            <div class="process-img">
                                <img src="{{ asset('assets/img/images/Commercial_Building.webp') }}" alt="Commercial Building">
                            </div>
                        </div>
                        <div class="banner-process-img">
                            <div class="process-img">
                                <img src="{{ asset('assets/img/images/Wastewater_Treatment.webp') }}" alt="Wastewater Treatment">
                            </div>
                        </div>
                        <div class="banner-process-img">
                            <div class="process-img">
                                <img src="{{ asset('assets/img/images/Infrastructure_Utilities.webp') }}" alt="Infrastructure Utilities">
                            </div>
                        </div>
                        <div class="banner-process-img">
                            <div class="process-img">
                                <img src="{{ asset('assets/img/images/Data_Centers_Institutional_Facilities.webp') }}" alt="Data Centers">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center pt-4 gy-4">
                    <div class="col-lg-6">
                        <div class="about-desc">
                            ...
                            <p class="mb-0 fs-6" style="line-height: 1.8; color: #4a4a4a;">Every panel undergoes comprehensive inspection throughout the manufacturing process to ensure adherence to 
quality benchmarks, accurate workmanship and seamless operation in demanding project environments.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-img-1 overflow-hidden" style="border-radius: 20px;">
                            <img src="{{ asset('assets/img/images/Quality_Assurance.webp') }}" alt="Quality Assurance" style="width: 100%; height: 380px; object-fit: cover; border-radius: 20px;">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-5">
                        <div class="position-relative slide-anim" data-delay="0.3" data-offset="100" data-direction="right">
                            <div class="overflow-hidden shadow-lg" style="border-radius: 20px;">
                                <img src="{{ asset('assets/img/images/Why_Choose_Us.webp') }}" alt="Why Choose Us" style="width: 100%; height: 500px; object-fit: cover; border-radius: 20px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="process-img-6 slide-anim" data-delay="0.3" data-offset="100" data-direction="left">
                            <img src="{{ asset('assets/img/images/Testing & Inspection.webp') }}" alt="Testing and Inspection">
                        </div>
                    </div>
                    <div class="col-lg-6">
